...
export default function CoachTeamMembersPage() {
  ...
  return (
    <main className="flex-grow mx-auto px-4 py-8 w-[90%] max-w-6xl">
      <div className="flex flex-col gap-6 mb-8">
        <div className="items-start gap-2 grid grid-cols-1 md:grid-cols-4">
          ...
          <div className="md:col-span-3">
            ...
            >
              <div className="top-4 right-4 absolute bg-green-100 px-4 py-2 rounded-full font-bold text-2xl text-green-800 whitespace-nowrap">
