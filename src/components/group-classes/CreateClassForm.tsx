    ...
    <div className="mx-auto w-[90%] max-w-3xl flex-1 py-4">
      ...
      {!stripeAccountConnected ? (
        <p className="py-4 text-center text-sm text-zinc-500">
          Your Stripe account hasn&apos;t been connected. Please go to your{" "}
          <Link
            href={"/dashobard/profile"}
        ...
        <p className="py-4 text-center text-sm text-zinc-500">
          Your stripe account is missing valuable information. Please go to your{" "}
          <Link
            href={"/dashobard/profile"}
            className="text-accent-green-100 hover:underline"
          >
