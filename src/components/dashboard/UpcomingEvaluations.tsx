...
export default function UpcomingEvaluations({
  ...
  return (
    <div className="flex w-full flex-1 flex-col">
      <section className="flex flex-1 flex-col overflow-hidden rounded-lg bg-white shadow-[0_0_6px_4px_#eee]">
      ...
      <Link
        ...
        className="ml-auto mt-4 block w-full rounded-md border px-4 py-2 text-center text-sm font-medium duration-200 hover:bg-accent-gray-100 md:w-fit"
      >
        See All Evaluations
      </Link>
    </div>
