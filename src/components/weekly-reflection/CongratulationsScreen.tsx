      ...
      <Card className="w-full max-w-3xl text-center">
        <CardHeader>
          <div className="mb-4 text-muted-foreground text-sm">
            {goalData.goals.length + 2}/{goalData.goals.length + 2} Weekly
            Reflection
          </div>
        ...
        <CardContent>
                  ...
                  >
                    ...
                    <Badge
                      ...
                      className={`self-start sm:self-center whitespace-nowrap ${
                        goal.dateCompleted || reflectionData[index].isCompleted
          ...
          <div className="flex justify-center gap-4">
            <Button className="bg-green-500 hover:bg-green-600 px-0 py-0 text-white">
              <Link href={"/app/goal-setting"} className="px-4 py-2">
