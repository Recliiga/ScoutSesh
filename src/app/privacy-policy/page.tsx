...
const definitions = [
  ...
  {
    title: "Application",
    content: `refers to ScoutSesh, the software
              program provided by the Company.`,
  },
  {
    title: "Company",
    content: ` (referred to as either "the
              Company", "We", "Us" or "Our"
              in this Agreement) refers to ScoutSesh.`,
  },
  {
    title: "Country",
    content: ` refers to: British Columbia, Canada`,
  },
  {
    title: "Device",
    content: ` means any device that can access the
              Service such as a computer, a cellphone or a digital tablet.`,
  },
  {
    title: "Personal Data",
    content: ` is any information that relates to
  ...
  },
  {
    ...
    content: ` means any natural or legal
  ...
  {
    title: "Usage Data",
    content: ` refers to data collected
  ...
  {
    title: "You",
    content: ` means the individual accessing or using the
        ...
        <ol className="flex list-inside list-decimal flex-col gap-2">
          {definitions.map((definition) => (
            <li key={definition.title}>
              <strong>{definition.title}</strong> {definition.content}
            </li>
          ))}
        </ol>
      </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        <ul>
          <li>
            By email:{" "}
            <Link
              href={"mailto:hello@recliiga.com"}
