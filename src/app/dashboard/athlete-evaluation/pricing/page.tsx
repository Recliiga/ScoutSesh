...
export default function CoachEvaluationSetup() {
                      ...
                      {tier.type === "range" && (
                        <>
                          ...
                          <Input
                            ...
                            onChange={(e) => {
                              if (
                                Number(e.target.value) > tier.evaluations.from
                              )
                                handleCustomPlanEvaluationsChange(index, {
                                  ...customPlanTiers[index].evaluations,
                                  to: Number(e.target.value),
            ...
            <div className="space-y-3 border-t pt-4">
              ...
              <div className="flex flex-col space-y-2">
                <Label htmlFor="firstEvaluationDays">
                  Days to deliver the first evaluation from the date of purchase
                  by the athlete:
                </Label>
                <div className="flex items-center space-x-2">
                  <div className="relative flex-grow">
                    <Input
                      ...
                      onChange={(e) =>
                        setFirstEvaluationDays(Number(e.target.value))
                      }
                      min={1}
                      className="pr-12"
                    />
